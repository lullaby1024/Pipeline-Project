...
from query_withsearchbar import query_search
...
class SearchHandler(tornado.web.RequestHandler):
    ...
    def get(self):
        ...
        ingredient_input = self.request.body['ingredient_search'][0]
        results = []
...
class Application(tornado.web.Application):
    def __init__(self):
        ...
        app_settings = {
            ...
            'static_path': os.path.joi n(os.path.dirname(__file__), 'static')
        }
        app_handlers = [
            (r'^/$', IndexHandler),
